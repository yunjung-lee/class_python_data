...
def mysqlData01():
    con = pymysql.connect(host = '192.168.93.128',user = 'biguser',password = '1234', db = 'userDB')
    cur = con.cursor()
...
mysqlMenu.add_command(label = 'MySQL정보 보기', command = mysqlData01)
mysqlMenu.add_command(label = 'MySQL정보 보기', command = mysqlData02)
