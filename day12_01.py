...
def openFile() :
    ...
    filename = askopenfilename(parent=window,filetypes=(("그림파일", "*.gif;*.jpg;*.png;*.tif;*.bmp"), ("모든파일", "*.*")))
...
def saveFile() :
    ...
    savefp = asksaveasfile(parent = window, mode = 'w',defaultextension='.png',filetypes=(("그림파일", "*.gif;*.jpg;*.png;*.tif;*.bmp"), ("모든파일", "*.*") ))
...
window.title('GIF 영상 처리&데이터 분석 Ver 0.02')
